...
<body class="login">
	<!-- BEGIN LOGO -->
	<div class="logo">
		<img src="<?php echo site_url('assets/img/logo-big.png'); ?>" alt="" /> 
	</div>
	<!-- END LOGO -->
	<!-- BEGIN LOGIN -->
	<div class="content">
		<!-- BEGIN LOGIN FORM -->
		<form class="form-vertical login-form" action="<?php echo site_url('user/validate'); ?>" method="post">
		...
		<form class="form-vertical forget-form" action="http://www.keenthemes.com/preview/metronic_admin/index.html" method="post">
		...
		<form class="form-vertical register-form" action="http://www.keenthemes.com/preview/metronic_admin/index.html" method="post">
			<h3 >Sign Up</h3>
